...
while (t<MaxTime & IterateFlag)
    ...
    hold off
    axis([0 Size 0 Size]);
    legend(h,'Susceptible','Exposed','Infectious','Reported','Culled','Location',"bestoutside");
    ...
    set(h(3),'LineWidth',2);
    legend(h,'Exposed','Infectious','Reports','Location',"bestoutside");
    ylabel 'Total Infected'

    subplot(4,1,4);
    h=plot(t,CullSheep,'-b',t,CullCattle,'-g');
    legend(h,'Sheep','Cattle', 'Location',"bestoutside");
